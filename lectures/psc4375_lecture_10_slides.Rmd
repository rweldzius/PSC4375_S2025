...
# Coefficients and fitted values
  ...
  - Use `coef()` to extrac estimated coefficients:
...
intresults08 %>%
  ...
  # geom_segment(aes(x = -25, y = 20, xend = 0, yend = 5.5),
  #                 arrow = arrow(length = unit(0.5, "cm")),
  #              color = "blue") +
  # annotate("text", x= -38, y = 20, label = "intercept", color = "blue") + 
  labs(x = "Market's margin for Obama",
       y = "Obama margin") +
  theme_bw()
```